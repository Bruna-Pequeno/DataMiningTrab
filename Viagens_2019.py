...
tabela_aggnm_sup.to_csv('C:/Spark/bin/tabela_aggnm_sup.csv')
...
tabela_aggnm_destino.to_csv('C:/Spark/bin/tabela_aggnm_destino.csv')
...
tabela_aggnm_cargo.to_csv('C:/Spark/bin/tabela_aggnm_cargo.csv')
...
tabela_aggnm_solicitante.to_csv('C:/Spark/bin/tabela_aggnm_solicitante.csv')
...
tabela_aggnm_sup_diaria.to_csv('C:/Spark/bin/tabela_aggnm_solicitante.csv')
